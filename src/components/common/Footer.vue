  ...
  <div>
    ...
    <div class="row justify-between">
      ...
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 footer-col">
        ...
        <p class="footer-small">ETH: 0x60a5dcb2fc804874883b797f37cbf1b0582ac2dd</p>
      </div>

      <!-- Second column  -->
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 footer-col">
        <p class="footer-large">Check out the source code on GitHub</p>
        <a class="footer-small" href="https://github.com/mds1/send-eth-tx">https://github.com/mds1/send-eth-tx</a>
      </div>

      <!-- Third column  -->
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 footer-col">
        <p class="footer-large">Questions, feedback, and suggestions</p>
        <p class="footer-small">Leave comments on the GitHub page</p>
        <br>
...
// 3-column footer formatting
// Here, only text syling and responsiveness of the footer is done. The sticky layout is done in App.vue
.Site-footer {
  text-align: center;
  background: $primary;
}
